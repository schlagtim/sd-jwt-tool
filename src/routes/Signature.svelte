<script lang="ts">
	...
	export let title: string = "Signatures & JWT Format";
	...
	export let validSDJWT: boolean = true;
...
<div class="box" style="--flex-size: {flexSize}, height: 100px">
	...
	<div class="signatures">
		<div class="row">
			<h3>SD-JWT format</h3>
			{#if !validSDJWT}
				<h3 class="signatures-right" style="color: red">Invalid</h3>
			{:else}
				<h3 class="signatures-right" style="color: green">Valid</h3>
			{/if}
		</div>
		<div class="row">
			<h3>JWT Signature:</h3>
